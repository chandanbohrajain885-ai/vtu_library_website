...
import { BookOpen, Download, Users, Search, Calendar, User, Phone, Mail, MapPin, Facebook, Twitter, Linkedin, Instagram, ChevronDown, LogOut, ExternalLink, FileText, Globe, Database, Plus, Edit, Trash2, Menu, X, ImageIcon, Video, VideoOff, MessageCircle } from 'lucide-react';
      ...
      script.onload = async () => {
        try {
          ...
          sessionRef.current = new StreamingAvatar({
            token: 'kH6vhsYvh92', // Your API key
            avatarId: 'Thaddeus_ProfessionalLook_public', // Your avatar ID
              ...
              {!isSessionActive ? (
                <div className="flex flex-col items-center justify-center h-full p-6 text-center">
                  ...
                  <Button
                    ...
                    disabled={isHeyGenLoading}
                    className="bg-primary hover:bg-primary/90 text-white px-6 py-2"
                  >
                    {isHeyGenLoading ? 'Connecting to Wayne...' : 'Start Video Chat'}
                  </Button>
                </div>
              ) : (
